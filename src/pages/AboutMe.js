...
const AboutMe = () => {
  return (
    <div>
      <h1>AboutMe</h1>
      <p>I am a person with a methodical, decisive approach and a great curiosity to face challenges efficiently.
        From a personal point of view, I consider myself open and extroverted. My professional career in the sports and social fields 
        led me to enthusiastically co-found my own Association. For two years, we led various activities in collaboration 
        with schools. During that time, we learned what teamwork is, we managed each event as a project and 
        we effectively solved each problem.
        These experiences were very enriching and the process of developing our own website sparked my interest in 
