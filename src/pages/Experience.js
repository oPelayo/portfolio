...
const experiences = [
  ...
  },
  {
    ...
    date: "2024",
    description:[
      "- Planing & Development an internal pilot application for digital content.",
      "- Developed with ASP.Net, MVC pattern.", 
      "- Managed Oracle databases.",
      "- Version control using Git.", 
      "- Deployed with Azure Cloud."
    ]
  },
  {
    ...
    date: "2017-2019",
    description:[
      "- Maintained of the company's website updating content, images and videos.",
      "- Provided technical advice to customers",
  ...
  },
  {
    ...
    date: "2013-2017",
    description:[
      "- Planed and executed of educational and leisure activities.", 
      "- Coordinated with the Educational team and Psychologists.", 
      "- Educational interventions, supervision of guidelines and methodologies to be applied.",
      "- Managed tem (6 people)"
    ]
  },
  {
    ...
    date: "2013-2017",
    description:[
      "- Developed and implemented educational projects.",
      "- Built the website using Joomla CMS.",
      "- Acted as the association's treasurer.",
      "- Managed the association's operations."
    ]
  }
